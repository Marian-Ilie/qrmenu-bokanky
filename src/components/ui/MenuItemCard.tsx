...
import { Info, Leaf, Snowflake } from "lucide-react"; // Importăm iconițe vectoriale
    ...
    return (
        <div className="flex flex-col gap-2 pb-6 border-b border-neutral-800/50 last:border-0">
            <div className="flex justify-between items-start gap-4">
                <h3 className="font-semibold text-lg leading-tight text-neutral-100">
                    {item.title}
                </h3>
            ...
            {hasNutrition && (
                <div className="mt-2">
                    <button
                        ...
                        className="inline-flex items-center gap-1.5 text-xs font-medium bg-neutral-900 hover:bg-neutral-800 text-neutral-300 px-3 py-1.5 rounded-full transition-colors outline-none"
                    >
